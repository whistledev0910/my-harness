...
Examples:
  ...
  curl -fsSL https://raw.githubusercontent.com/whistledev0910/my-harness/main/scripts/install-harness.sh | bash -s -- --merge --yes
  ...
  curl -fsSL https://raw.githubusercontent.com/whistledev0910/my-harness/main/scripts/install-harness.sh | bash -s -- --merge --refresh-agent-shim --yes
  curl -fsSL https://raw.githubusercontent.com/whistledev0910/my-harness/main/scripts/install-harness.sh | bash -s -- --claude --yes
EOF
}
...
SOURCE_ROOT=""
SOURCE_MODE="remote"
SOURCE_BASE_URL="${HARNESS_SOURCE_BASE_URL:-https://raw.githubusercontent.com/whistledev0910/my-harness/main}"
SOURCE_BASE_URL="${SOURCE_BASE_URL%/}"
CORE_SOURCE_BASE_URL="${HARNESS_CORE_SOURCE_BASE_URL:-https://raw.githubusercontent.com/whistledev0910/my-harness/main}"
