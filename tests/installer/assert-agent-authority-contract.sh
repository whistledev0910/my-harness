...
grep -Fq 'Build `harness`, a Rust CLI installed with the default core' "$root/AGENTS.md"
grep -Fq 'docs/plans/active/rust-harness-core-maintenance-cli.md' "$root/AGENTS.md"
